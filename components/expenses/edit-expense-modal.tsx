  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      await updateExpense({
        ...
        merchant: formData.merchant || undefined, // ✅ Send undefined instead of empty string
        description: formData.description || undefined, // ✅ Send undefined instead of empty string
        category_id: formData.category_id || undefined, // ✅ Send undefined instead of empty string
        comment: formData.comment || undefined, // ✅ Send undefined instead of empty string
      })
      onClose()
    } catch (err) {
